...
依赖可能非最新版本，可前往[maven中央仓库](https://central.sonatype.com/artifact/io.github.liyao52033/common-spring-boot-starter)查看
...
需提前在`resource/template`下准备`freemaker`模板文件，将下面信息填好后可快速生成crud
